package com.example.im.service.message.service;

import com.alibaba.fastjson.JSONObject;
import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.core.toolkit.CollectionUtils;
import com.example.im.codec.pack.message.MessageReadedPack;
import com.example.im.codec.pack.message.RecallMessageNotifyPack;
import com.example.im.common.ResponseVO;
import com.example.im.common.constant.Constants;
import com.example.im.common.enums.ConversationTypeEnum;
import com.example.im.common.enums.DelFlagEnum;
import com.example.im.common.enums.MessageErrorCode;
import com.example.im.common.enums.command.Command;
import com.example.im.common.enums.command.GroupEventCommand;
import com.example.im.common.enums.command.MessageCommand;
import com.example.im.common.model.ClientInfo;
import com.example.im.common.model.SyncReq;
import com.example.im.common.model.SyncResp;
import com.example.im.common.model.message.MessageReadedContent;
import com.example.im.common.model.message.MessageReciveAckContent;
import com.example.im.common.model.message.OfflineMessageContent;
import com.example.im.common.model.message.RecallMessageContent;
import com.example.im.service.conversation.service.ConversationService;
import com.example.im.service.group.service.ImGroupMemberService;
import com.example.im.service.message.dao.ImMessageBodyEntity;
import com.example.im.service.message.dao.mapper.ImMessageBodyMapper;
import com.example.im.service.seq.RedisSeq;
import com.example.im.service.utils.ConversationIdGenerate;
import com.example.im.service.utils.GroupMessageProducer;
import com.example.im.service.utils.MessageProducer;
import com.example.im.service.utils.SnowflakeIdWorker;
